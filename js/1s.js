...
document.getElementById("modal-content").onclick = function(){
  if (counter==1) {
    window.location.href="../pages/1st.html";
  }
}
document.getElementById("one1").onclick = function(){
  document.querySelector(".bg-modal").style.display = "block";
  document.getElementById("img").src="../images/zoom/1s1.jpg";
  document.getElementById("img").setAttribute('usemap', "");
  document.getElementById("imgans").src="../images/zoom/questions/sq.jpg";
}
document.getElementById("one2").onclick = function(){
  document.querySelector(".bg-modal").style.display = "block";
  document.getElementById("img").src="../images/zoom/1s2.jpg";
  document.getElementById("img").setAttribute('usemap', "");
  document.getElementById("imgans").src="../images/zoom/questions/sq.jpg";
  counter = 1;
}
document.getElementById("one3").onclick = function(){
  document.querySelector(".bg-modal").style.display = "block";
  document.getElementById("img").src="../images/zoom/1s3.jpg";
  document.getElementById("img").setAttribute('usemap', "");
  document.getElementById("imgans").src="../images/zoom/questions/sq.jpg";
  counter = 1;
}
document.getElementById("one4").onclick = function(){
  document.querySelector(".bg-modal").style.display = "block";
  document.getElementById("img").src="../images/zoom/1s4.jpg";
  document.getElementById("img").setAttribute('usemap', "");
  document.getElementById("imgans").src="../images/zoom/questions/sq.jpg";
}
