...
document.getElementById("one1").onclick = function(){
  document.querySelector(".bg-modal").style.display = "block";
  document.getElementById("img").src="../images/zoom/1l1.jpg";
  document.getElementById("img").setAttribute('usemap', "#map11");
  document.getElementById("imgans").src="../images/zoom/questions/1l1q.jpg";
  ...
  document.getElementById("audioplayer").src = "../audio/test1/1.mp3";
  addAns(1, 0, 0, "", 32, 175);
  addAns(2, 0, 0, "", 32, 265);
  addAns(3, 0, 0, "", 32, 516);
  addAns(4, 0, 0, "", 32, 650);
  addAns(5, 0, 0, "", 32, 877);
  addAns(6, 0, 0, "", 32, 1050);
}
