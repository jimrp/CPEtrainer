...
document.getElementById("modal-ans").onclick = function(){
  window.location.href="../pages/1s.html";
}
document.getElementById("one1").onclick = function(){
  document.querySelector(".bg-modal").style.display = "block";
  document.getElementById("img").src="../images/zoom/1st1.jpg";
  document.getElementById("img").setAttribute('usemap', "");
  document.getElementById("imgans").src="../images/zoom/questions/1stq.jpg";
}
document.getElementById("one2").onclick = function(){
  document.querySelector(".bg-modal").style.display = "block";
  document.getElementById("img").src="../images/zoom/1st2.jpg";
  document.getElementById("img").setAttribute('usemap', "");
  document.getElementById("imgans").src="../images/zoom/questions/1stq.jpg";
}
document.getElementById("one3").onclick = function(){
  document.querySelector(".bg-modal").style.display = "block";
  document.getElementById("img").src="../images/zoom/1st3.jpg";
  document.getElementById("img").setAttribute('usemap', "");
  document.getElementById("imgans").src="../images/zoom/questions/1stq.jpg";
}
document.getElementById("one4").onclick = function(){
  document.querySelector(".bg-modal").style.display = "block";
  document.getElementById("img").src="../images/zoom/1st4.jpg";
  document.getElementById("img").setAttribute('usemap', "");
  document.getElementById("imgans").src="../images/zoom/questions/1stq.jpg";
}
document.getElementById("one5").onclick = function(){
  document.querySelector(".bg-modal").style.display = "block";
  document.getElementById("img").src="../images/zoom/1st5.jpg";
  document.getElementById("img").setAttribute('usemap', "");
  document.getElementById("imgans").src="../images/zoom/questions/1stq.jpg";
}
document.getElementById("one6").onclick = function(){
  document.querySelector(".bg-modal").style.display = "block";
  document.getElementById("img").src="../images/zoom/1st6.jpg";
  document.getElementById("img").setAttribute('usemap', "");
  document.getElementById("imgans").src="../images/zoom/questions/1stq.jpg";
}
